...
HD_PWD='/home/fmlab3/vivado_projects/controllernewdynamic2/controllernewdynamic2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conrtollernewdynamic2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conrtollernewdynamic2_wrapper.tcl -notrace
