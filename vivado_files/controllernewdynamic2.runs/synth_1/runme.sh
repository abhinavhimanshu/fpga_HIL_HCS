...
HD_PWD='/home/fmlab3/vivado_projects/controllernewdynamic2/controllernewdynamic2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conrtollernewdynamic2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conrtollernewdynamic2_wrapper.tcl
